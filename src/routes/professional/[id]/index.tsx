...
import { For, Match, Show, Suspense, Switch, type Accessor } from 'solid-js'
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-wrap gap-6">
        ...
        <Show when={professional.reviewCount > 0}>
          <div class="flex items-center gap-2">
        ...
        <Show when={professional.fromIrs}>
          <Badge variant="outline" class="flex items-center gap-1">
            <img src="/images/irs.svg" class="size-5" />
            IRS Approved
          </Badge>
        </Show>
      </div>
